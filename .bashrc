...
PATH=$PATH:/home/vagrant/softwares/:/home/vagrant/softwares/android-ndk-r11c/:/home/vagrant/softwares/android/android-sdk/build-tools/23.0.2/
function ta ()
{
    #clean older info
    rm -rf tags
    ...
    ctags -R . *.c *.h *.cpp *.cc --tag-relative=yes ./
}

#export PS1="${debian_chroot:+($debian_chroot)}\[\e[32m\]\u\[\e[0m\]@\h:\w$"
